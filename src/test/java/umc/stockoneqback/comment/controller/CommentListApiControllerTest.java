                    ...
                    .andDo(
                            document(
                                    ...
                                    responseFields(
                                            ...
                                            fieldWithPath("CommentListResponse[].userId").type(JsonFieldType.NUMBER).description("댓글 ID"),
                                            ...
                                            fieldWithPath("CommentListResponse[].replyList[].userId").type(JsonFieldType.NUMBER).description("대댓글 ID"),
