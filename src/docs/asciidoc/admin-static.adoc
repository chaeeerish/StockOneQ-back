...
Request Parameter
include::{snippets}/AdminStaticApi/CommonError/Case1/request-body.adoc[]

==== HTTP Response
include::{snippets}/AdminStaticApi/CommonError/Case1/http-response.adoc[]
include::{snippets}/AdminStaticApi/CommonError/Case1/response-body.adoc[]
...
Request Parameter
include::{snippets}/AdminStaticApi/DeleteFA/Success/request-body.adoc[]
