...
include::{snippets}/UserApi/Information/FindLoginId/Success/response-body.adoc[]
...
include::{snippets}/UserApi/Information/Get/Success/Case1/response-body.adoc[]
...
include::{snippets}/UserApi/Information/Get/Success/Case2/response-body.adoc[]
...
include::{snippets}/UserApi/Information/Get/Success/Case3/response-body.adoc[]
