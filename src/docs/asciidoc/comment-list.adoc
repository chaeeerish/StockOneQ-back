...
include::{snippets}/CommentApi/List/All/Failure/Case1/query-parameters.adoc[]

HTTP Response
include::{snippets}/CommentApi/List/All/Failure/Case1/http-response.adoc[]
include::{snippets}/CommentApi/List/All/Failure/Case1/response-body.adoc[]
...
include::{snippets}/CommentApi/List/All/Success/query-parameters.adoc[]

HTTP Response
include::{snippets}/CommentApi/List/All/Success/http-response.adoc[]
include::{snippets}/CommentApi/List/All/Success/response-body.adoc[]
