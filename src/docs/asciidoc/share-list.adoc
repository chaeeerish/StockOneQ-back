...
include::{snippets}/ShareApi/SelectBox/Failure/response-body.adoc[]
...
include::{snippets}/ShareApi/SelectBox/Success/response-body.adoc[]
...
include::{snippets}/ShareApi/List/Failure/Case1/query-parameters.adoc[]

HTTP Response
include::{snippets}/ShareApi/List/Failure/Case1/http-response.adoc[]
include::{snippets}/ShareApi/List/Failure/Case1/response-body.adoc[]
...
include::{snippets}/ShareApi/List/Failure/Case2/query-parameters.adoc[]

HTTP Response
include::{snippets}/ShareApi/List/Failure/Case2/http-response.adoc[]
include::{snippets}/ShareApi/List/Failure/Case2/response-body.adoc[]
...
include::{snippets}/ShareApi/List/Failure/Case3/query-parameters.adoc[]

HTTP Response
include::{snippets}/ShareApi/List/Failure/Case3/http-response.adoc[]
include::{snippets}/ShareApi/List/Failure/Case3/response-body.adoc[]
...
include::{snippets}/ShareApi/List/Success/query-parameters.adoc[]

HTTP Response
include::{snippets}/ShareApi/List/Success/http-response.adoc[]
include::{snippets}/ShareApi/List/Success/response-body.adoc[]
