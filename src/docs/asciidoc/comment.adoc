...
include::{snippets}/CommentApi/Create/Failure/Case1/response-body.adoc[]
...
include::{snippets}/CommentApi/Update/Failure/Case1/response-body.adoc[]
...
include::{snippets}/CommentApi/Update/Failure/Case2/response-body.adoc[]
...
include::{snippets}/CommentApi/Delete/Failure/Case1/response-body.adoc[]
...
include::{snippets}/CommentApi/Delete/Failure/Case2/response-body.adoc[]
