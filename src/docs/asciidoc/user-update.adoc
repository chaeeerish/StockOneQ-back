...
include::{snippets}/UserApi/Update/Failure/Case1/response-body.adoc[]
...
include::{snippets}/UserApi/Update/Failure/Case2/response-body.adoc[]
...
include::{snippets}/UserApi/validateUpdatePassword/Failure/Case1/response-body.adoc[]
...
include::{snippets}/UserApi/validateUpdatePassword/Success/response-body.adoc[]
