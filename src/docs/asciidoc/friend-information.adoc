...
include::{snippets}/FriendApi/Information/Friends/Failure/Case1/query-parameters.adoc[]
...
include::{snippets}/FriendApi/Information/Friends/Success/query-parameters.adoc[]

HTTP Response
include::{snippets}/FriendApi/Information/Friends/Success/http-response.adoc[]
include::{snippets}/FriendApi/Information/Friends/Success/response-body.adoc[]
...
include::{snippets}/FriendApi/Information/WaitingFriends/Failure/Case1/query-parameters.adoc[]
...
include::{snippets}/FriendApi/Information/WaitingFriends/Success/query-parameters.adoc[]

HTTP Response
include::{snippets}/FriendApi/Information/WaitingFriends/Success/http-response.adoc[]
include::{snippets}/FriendApi/Information/WaitingFriends/Success/response-body.adoc[]
...
include::{snippets}/FriendApi/Information/RequestedFriends/Failure/Case1/query-parameters.adoc[]
...
include::{snippets}/FriendApi/Information/RequestedFriends/Success/query-parameters.adoc[]

HTTP Response
include::{snippets}/FriendApi/Information/RequestedFriends/Success/http-response.adoc[]
include::{snippets}/FriendApi/Information/RequestedFriends/Success/response-body.adoc[]
