...
include::{snippets}/ShareApi/Create/Failure/Case1/query-parameters.adoc[]
...
include::{snippets}/ShareApi/Create/Failure/Case1/response-body.adoc[]
...
include::{snippets}/ShareApi/Create/Failure/Case2/query-parameters.adoc[]
...
include::{snippets}/ShareApi/Create/Failure/Case2/response-body.adoc[]
...
include::{snippets}/ShareApi/Create/Success/query-parameters.adoc[]
...
include::{snippets}/ShareApi/Update/Failure/Case1/query-parameters.adoc[]
...
include::{snippets}/ShareApi/Update/Failure/Case1/response-body.adoc[]
...
include::{snippets}/ShareApi/Update/Failure/Case2/query-parameters.adoc[]
...
include::{snippets}/ShareApi/Update/Failure/Case2/response-body.adoc[]

=== 3. 게시글 수정에 성공한다
HTTP Request
include::{snippets}/ShareApi/Update/Success/http-request.adoc[]
include::{snippets}/ShareApi/Update/Success/request-headers.adoc[]
include::{snippets}/ShareApi/Update/Success/query-parameters.adoc[]
...
include::{snippets}/ShareApi/Detail/Failure/Case1/response-body.adoc[]
...
include::{snippets}/ShareApi/Detail/Failure/Case2/response-body.adoc[]
...
include::{snippets}/ShareApi/Detail/Success/response-body.adoc[]
...
include::{snippets}/ShareApi/Delete/Failure/Case1/query-parameters.adoc[]

HTTP Response
include::{snippets}/ShareApi/Delete/Failure/Case1/http-response.adoc[]
include::{snippets}/ShareApi/Delete/Failure/Case1/response-body.adoc[]
...
include::{snippets}/ShareApi/Delete/Failure/Case2/query-parameters.adoc[]

HTTP Response
include::{snippets}/ShareApi/Delete/Failure/Case2/http-response.adoc[]
include::{snippets}/ShareApi/Delete/Failure/Case2/response-body.adoc[]

=== 3. 게시글 삭제에 성공한다
HTTP Request
include::{snippets}/ShareApi/Delete/Success/http-request.adoc[]
include::{snippets}/ShareApi/Delete/Success/request-headers.adoc[]
include::{snippets}/ShareApi/Delete/Success/query-parameters.adoc[]
