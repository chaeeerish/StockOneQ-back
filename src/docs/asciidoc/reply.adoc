...
include::{snippets}/ReplyApi/Create/Failure/Case1/response-body.adoc[]
...
include::{snippets}/ReplyApi/Update/Failure/Case1/response-body.adoc[]
...
include::{snippets}/ReplyApi/Update/Failure/Case2/response-body.adoc[]
...
include::{snippets}/ReplyApi/Delete/Failure/Case1/response-body.adoc[]
...
include::{snippets}/ReplyApi/Delete/Failure/Case2/response-body.adoc[]
